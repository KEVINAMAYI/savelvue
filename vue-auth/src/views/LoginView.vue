...
<template>
  <main class="relative z-10">
    ...
    <section class="pt-5">
      ...
      <div v-if="authStore.success.message"
      ...
      <div v-if="authStore.errors.error"
           ...
           role="alert">
        <span class="font-medium"> {{ authStore.errors.error }}</span>
      </div>


      <div class="flex flex-col  -mt-8 items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form @submit.prevent="authStore.login(form)" class="space-y-4 md:space-y-6">
              <div>
              ...
              <div class="flex items-center justify-between">
                ...
                <!--                  </div>-->
                <!--                </div>-->
                <router-link to="/forgot-password" href="#"
